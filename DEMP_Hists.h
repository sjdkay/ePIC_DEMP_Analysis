...
void DefHists(TString InBeamE, Bool_t EventDists, Bool_t Kinematics, Bool_t ZDC, Bool_t B0, Bool_t QA, Bool_t Results){
  ...
  if (EventDists == kTRUE){
    ...
    TH2D* h2_Pi_pTheta_MC = new TH2D("h2_Pi_pTheta_MC", "#pi MC Truth; #theta (deg); P(GeV/C); Rate/bin (Hz)", NBins_Theta, 0, 60, 1.5*NBins_Energy, 0, 150);
  ...
  if (Kinematics == kTRUE){
    ...
    TH1D* h1_teXBE_Reco = new TH1D("h1_teXBE_Reco", "-t_{eXBE} Reconstructed; -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 200, -0.5, 1.5);
    ...
    if (B0 == kTRUE){
      ...
      TH1D* h1_teXBE_B0Reco_NoCuts = new TH1D("h1_teXBE_B0Reco_NoCuts", "-t_{eXBE} Reconstructed (Q^{2}_{DA} Cuts Only, B0 n events only); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 200, -0.5, 1.5);
      ...
      TH2D* h2_Q2teXBE_B0Reco_NoCuts = new TH2D("h2_Q2teXBE_B0Reco_NoCuts", "Q^{2}_{DA} vs -t_{eXBE} Reconstructed (Q^{2}_{DA} Cuts Only, B0 n events only); Q^{2}_{DA} (GeV^{2}); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 40, 0, 40, 40, 0, 1.6);
      ...
      TH1D* h1_teXBE_B0Reco = new TH1D("h1_teXBE_B0Reco", "-t_{eXBE} Reconstructed (B0 n events only); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 200, -0.5, 1.5);
      ...
      TH2D* h2_Q2teXBE_B0Reco = new TH2D("h2_Q2teXBE_B0Reco", "Q^{2}_{DA} vs -t_{eXBE} Reconstructed (B0 n events only); Q^{2}_{DA} (GeV^{2}); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 40, 0, 40, 40, 0, 1.6);
    ...
    if (ZDC == kTRUE){
      ...
      TH1D* h1_teXBE_ZDCReco_NoCuts = new TH1D("h1_teXBE_ZDCReco_NoCuts", "-t_{eXBE} Reconstructed (Q^{2} Cuts Only, ZDC n events only); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 200, -0.5, 1.5);
      ...
      TH2D* h2_Q2teXBE_ZDCReco_NoCuts = new TH2D("h2_Q2teXBE_ZDCReco_NoCuts", "Q^{2} vs -t_{eXBE} Reconstructed (Q^{2} Cuts Only, ZDC n events only); Q^{2} (GeV^{2}); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 40, 0, 40, 40, 0, 1.6);
      ...
      TH1D* h1_teXBE_ZDCReco = new TH1D("h1_teXBE_ZDCReco", "-t_{eXBE} Reconstructed (ZDC n events only); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 200, -0.5, 1.5);
      ...
      TH2D* h2_Q2teXBE_ZDCReco = new TH2D("h2_Q2teXBE_ZDCReco", "Q^{2} vs -t_{eXBE} Reconstructed (ZDC n events only); Q^{2} (GeV^{2}); -t_{eXBE} (GeV^{2}); Rate/bin (Hz)", 40, 0, 40, 40, 0, 1.6);
  ...
  if (QA == kTRUE){
    ...
    TH1D* h1_teXBE_Res_QA = new TH1D("h1_teXBE_Res_QA", "-t_{eXBE} Resolution (%); (t_{eXBE} - t_{MC})/t_{MC} (%); Rate/1% bin (Hz)", 400, -200, 200);
    ...
    TH1D* h1_teXBE_Res_Abs_QA = new TH1D("h1_teXBE_Res_Abs_QA", "-t_{eXBE} Resolution; (t_{eXBE} - t_{MC}) (GeV^{2}); Rate/0.005 GeV^{2} bin (Hz)", 200, -0.5, 0.5);
    ...
    if (ZDC == kTRUE){
      ...
      TH1D* h1_teXBE_Res_QA_ZDC = new TH1D("h1_teXBE_Res_QA_ZDC", "-t_{eXBE} Resolution (%), n ZDC Hits Only; (t_{eXBE} - t_{MC})/t_{MC} (%); Rate/1% bin (Hz)", 400, -200, 200);
      ...
      TH1D* h1_teXBE_Res_Abs_QA_ZDC = new TH1D("h1_teXBE_Res_Abs_QA_ZDC", "-t_{eXBE} Resolution, n ZDC Hits Only; (t_{eXBE} - t_{MC}) (GeV^{2}); Rate/0.005 GeV^{2} bin (Hz)", 200, -0.5, 0.5);
    ...
    if (B0 == kTRUE){
      ...
      TH1D* h1_teXBE_Res_QA_B0 = new TH1D("h1_teXBE_Res_QA_B0", "-t_{eXBE} Resolution (%), n B0 Hits Only; (t_{eXBE} - t_{MC})/t_{MC} (%); Rate/1% bin (Hz)", 400, -200, 200);
      ...
      TH1D* h1_teXBE_Res_Abs_QA_B0 = new TH1D("h1_teXBE_Res_Abs_QA_B0", "-t_{eXBE} Resolution, n B0 Hits Only; (t_{eXBE} - t_{MC}) (GeV^{2}); Rate/0.005 GeV^{2} bin (Hz)", 200, -0.5, 0.5);
    ...
    TH2D* h2_teXBEComp = new TH2D("h2_teXBEComp", "-t_{eXBE} vs -t_{MC}; -t_{eXBE} (GeV/c); -t_{MC} (GeV/c); Rate/bin (Hz)", 40, 0, 1.6, 40, 0, 1.6);
    ...
    if(ZDC == kTRUE){
      ...
      TH2D* h2_teXBEComp_ZDC = new TH2D("h2_teXBEComp_ZDC", "-t_{eXBE} vs -t_{MC}, n ZDC Hits; -t_{eXBE} (GeV/c); -t_{MC} (GeV/c); Rate/bin (Hz)", 80, 0, 1.6, 80, 0, 1.6);
    ...
    if(B0 == kTRUE){
      ...
      TH2D* h2_teXBEComp_B0 = new TH2D("h2_teXBEComp_B0", "-t_{eXBE} vs -t_{MC}, n B0 Hits; -t_{eXBE} (GeV/c); -t_{MC} (GeV/c); Rate/bin (Hz)", 80, 0, 1.6, 80, 0, 1.6);
    ...
    TH1D* h1_QA_Q2Rec_Res = new TH1D("h1_QA_Q2Rec_Res", "Q^{2}_{Rec} Resolution;(Q^{2}_{Rec}-Q^{2}_{MC})/Q^{2}_{MC}(%); Rate/1% Bin (Hz) ", 80, -40, 40);
    ...
    TH1D* h1_QA_ySig_Res = new TH1D("h1_QA_ySig_Res", "y_{Sig} Resolution;(y_{Sig}-y_{MC})/y_{MC}(%); Rate/1% Bin (Hz) ", 80, -40, 40);
    TH2D* h2_QA_Q2Rec_Q2MC = new TH2D("h2_QA_Q2Rec_Q2MC","Q^{2}_{Rec} vs Q^{2}_{MC}; Q^{2}_{Rec} (GeV/c^{2}); Q^{2}_{MC} (GeV/c^{2})(%); Rate/1% Bin (Hz)", 100, 0, 50, 100, 0, 50);
    TH2D* h2_QA_Q2DA_Q2MC = new TH2D("h2_QA_Q2DA_Q2MC","Q^{2}_{DA} vs Q^{2}_{MC}; Q^{2}_{DA} (GeV/c^{2}); Q^{2}_{MC} (GeV/c^{2})(%); Rate/1% Bin (Hz)", 100, 0, 50, 100, 0, 50);
    TH2D* h2_QA_Q2Sig_Q2MC = new TH2D("h2_QA_Q2Sig_Q2MC","Q^{2}_{Sig} vs Q^{2}_{MC}; Q^{2}_{Sig} (GeV/c^{2}); Q^{2}_{MC} (GeV/c^{2})(%); Rate/1% Bin (Hz)", 100, 0, 50, 100, 0, 50);
    TH2D* h2_QA_Q2Rec_Q2Res = new TH2D("h2_QA_Q2Rec_Q2Res","Q^{2}_{Rec} vs Q^{2}_{Res}; Q^{2}_{Rec} (GeV/c^{2}); (Q^{2}_{Rec}-Q^{2}_{MC})/Q^{2}_{MC}(%); Rate/1% Bin (Hz)", 100, 0, 50, 200, -100, 100);
    TH2D* h2_QA_Q2DA_Q2Res = new TH2D("h2_QA_Q2DA_Q2Res","Q^{2}_{DA} vs Q^{2}_{Res}; Q^{2}_{DA} (GeV/c^{2}); (Q^{2}_{DA}-Q^{2}_{MC})/Q^{2}_{MC}(%); Rate/1% Bin (Hz)", 100, 0, 50, 200, -100, 100);
    TH2D* h2_QA_Q2Sig_Q2Res = new TH2D("h2_QA_Q2Sig_Q2Res","Q^{2}_{Sig} vs Q^{2}_{Res}; Q^{2}_{Sig} (GeV/c^{2}); (Q^{2}_{Sig}-Q^{2}_{MC})/Q^{2}_{MC}(%); Rate/1% Bin (Hz)", 100, 0, 50, 200, -100, 100);
  ...
  if (Results == kTRUE){
    ...
    h1_WResult_v2[0] = new TH1D("h1_WResult_v2_0", "W, DEMP Events with Cuts, 5 < Q^{2}_{DA} < 35, -t_{eXBABE} < 0.18; W (GeV); Rate/(0.5 GeV) (Hz)", 80, -10, 30);
    h1_WResult_MC_v2[0] = new TH1D("h1_WResult_MC_v2_0", "W_{MC}, DEMP Events with Cuts, 5 < Q^{2}_{DA} < 35, -t_{eXBABE} < 0.18; W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", 80, -10, 30);
    ...
    if(ZDC == kTRUE){
      ...
      h1_WResult_v2_ZDC[0] = new TH1D("h1_WResult_v2_ZDC_0", "W, DEMP Events with Cuts, 5 < Q^{2}_{DA} < 35, -t_{eXBABE} < 0.18, (n in ZDC only) < 0.18; W (GeV); Rate/(0.5 GeV) (Hz)", 80, -10, 30);
      h1_WResult_MC_v2_ZDC[0] = new TH1D("h1_WResult_MC_v2_ZDC_0", "W_{MC}, DEMP Events with Cuts, 5 < Q^{2}_{DA} < 35, -t_{eXBABE} < 0.18, (n in ZDC only) < 0.18; W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", 80, -10, 30);
    }
    if (B0 == kTRUE){
      ...
      h1_WResult_v2_B0[0] = new TH1D("h1_WResult_v2_B0_0", "W, DEMP Events with Cuts, 5 < Q^{2}_{DA} < 35, -t_{eXBABE} < 0.18, (n in B0 only) < 0.18; W (GeV); Rate/(0.5 GeV) (Hz)", 80, -10, 30);
      h1_WResult_MC_v2_B0[0] = new TH1D("h1_WResult_MC_v2_B0_0", "W_{MC}, DEMP Events with Cuts, 5 < Q^{2}_{DA} < 35, -t_{eXBABE} < 0.18, (n in B0 only) < 0.18; W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", 80, -10, 30);
    }
    ...
    for(Int_t i = 0; i < 30; i++){
      ...
      h2_tRes_Result[0] = new TH2D(Form("h2_tRes_Result_%i", i+1), Form("(t_{eXBABE} - t_{MC}) as a fn of -t_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f; -t_{MC} (GeV^{2}); (t_{eXBABE} - t_{MC}) (GeV^{2}); Rate (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, 0, 1.6, 200, -0.5, 0.5);
	...
	h1_WResult_B0[i+1] = new TH1D(Form("h1_WResult_B0_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, (n in B0 only); W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
      ...
      if(i < 5){
	h1_WResult_v2[i+1] = new TH1D(Form("h1_WResult_v2_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.12; W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	h1_WResult_MC_v2[i+1] = new TH1D(Form("h1_WResult_MC_v2_%i", i+1), Form("W_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.12; W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	if(ZDC == kTRUE){
	  h1_WResult_v2_ZDC[i+1] = new TH1D(Form("h1_WResult_v2_ZDC_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.12, (n in ZDC only); W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	  h1_WResult_MC_v2_ZDC[i+1] = new TH1D(Form("h1_WResult_MC_v2_ZDC_%i", i+1), Form("W_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.12, (n in ZDC only); W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	}
	if(B0 == kTRUE){
	  h1_WResult_v2_B0[i+1] = new TH1D(Form("h1_WResult_v2_B0_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.12, (n in B0 only); W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	  h1_WResult_MC_v2_B0[i+1] = new TH1D(Form("h1_WResult_MC_v2_B0_%i", i+1), Form("W_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.12, (n in B0 only); W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	}
      }
      else{
	h1_WResult_v2[i+1] = new TH1D(Form("h1_WResult_v2_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.18; W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	h1_WResult_MC_v2[i+1] = new TH1D(Form("h1_WResult_MC_v2_%i", i+1), Form("W_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.18; W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	if(ZDC == kTRUE){
	  h1_WResult_v2_ZDC[i+1] = new TH1D(Form("h1_WResult_v2_ZDC_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.18, (n in ZDC only); W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	  h1_WResult_MC_v2_ZDC[i+1] = new TH1D(Form("h1_WResult_MC_v2_ZDC_%i", i+1), Form("W_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.18, (n in ZDC only); W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	}
	if(B0 == kTRUE){
	  h1_WResult_v2_B0[i+1] = new TH1D(Form("h1_WResult_v2_B0_%i", i+1), Form("W, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.18, (n in B0 only); W (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	  h1_WResult_MC_v2_B0[i+1] = new TH1D(Form("h1_WResult_MC_v2_B0_%i", i+1), Form("W_{MC}, DEMP Events with Cuts, %2.1f < Q^{2}_{DA} < %2.1f, -t_{eXBABE} < 0.18, (n in B0 only); W_{MC} (GeV); Rate/(0.5 GeV) (Hz)", Q2Vals[i], Q2Vals[i+1]), 80, -10, 30);
	}
      }
    }
    gDirectory->cd("../");
