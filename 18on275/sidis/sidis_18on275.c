void sidis_18on275()
{
  ...
  for (unsigned int i = 0; i < 5; i++) { //19
    for (unsigned int j = 0; j < 2325; j++) { //1921
      // Construct the file path
      filepath = Form("root://dtn-eic.jlab.org//work/eic2/EPIC/RECO/24.12.0/epic_craterlake/DIS/NC/18x275/minQ2=100/pythia8NCDIS_18x275_minQ2=100_beamEffects_xAngle=-0.025_hiDiv_%i.%04i.eicrecon.tree.edm4eic.root", i + 1, j);
  ...
  /* TChain *mychain = new TChain("events");
     ...
     TString filePath = Form("pythia8NCDIS_18x275_minQ2=100_beamEffects_xAngle=-0.025_hiDiv_%i.%04i.eicrecon.tree.edm4eic.root", i + 1, j);
  ...
  //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  // Define Histograms
  TH2* enbfTruthw_Thetap = new TH2D("enbfTruthw_Thethap","e' truth no beam effects #theta vs P; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,100);
  TH2* pinbfTruthw_Thetap = new TH2D("pinbfTruthw_Thethap","#pi^{+} truth no beam effects #theta vs P; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,150); //change
  TH2* nnbfTruthw_Thetap  = new TH2D("nnbfTruthw_Thethap","n truth no beam effects #theta vs P; #theta (Deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,250);//change 
  
  TH2* eTruthw_Thetap  = new TH2D("eTruthw_Thethap","e' truth #theta vs P; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,100);
  TH2* piTruthw_Thetap = new TH2D("piTruthw_Thethap","#pi^{+} truth #theta vs P; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,150); //change
  TH2* nTruthw_Thetap  = new TH2D("nTruthw_Thethap","n truth #theta vs P; #theta (Deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,250); //change 
  ...
  TH2* nTruthw_rot_Thetap  = new TH2D("nTruthw_rot_Thethap","n truth #theta* vs P around p axis; #theta* (Deg); P (GeV/c); Rate/bin (Hz)",100,0.0,180,100,80,280); //change
  ...
  TH2* eRecw_Thetap  = new TH2D("eRecw_Thethap","e' rec #theta vs P; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,100);
  TH2* eRecw_Thetaphi  = new TH2D("eRecw_Thethaphi","e' rec #theta vs #phi; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,-200,200);
  TH2* piRecw_Thetap = new TH2D("piRecw_Thethap","#pi^{+} rec #theta vs P; #theta (deg); P (GeV/c); Rate/bin (Hz)",100,0,180,100,0,150); //change
  ...
  c1a->Print("sidis_reco_18on275.pdf[");
  c1a->Print("sidis_reco_18on275.pdf");
  c2a->Print("sidis_reco_18on275.pdf");
  c3_a->Print("sidis_reco_18on275.pdf");
  c1->Print("sidis_reco_18on275.pdf");
  c2->Print("sidis_reco_18on275.pdf");
  c3b->Print("sidis_reco_18on275.pdf");
  c3->Print("sidis_reco_18on275.pdf");
  c3a->Print("sidis_reco_18on275.pdf");
  c3c->Print("sidis_reco_18on275.pdf");
  c4->Print("sidis_reco_18on275.pdf");
  c4a->Print("sidis_reco_18on275.pdf");
  c5->Print("sidis_reco_18on275.pdf");
  c5_a->Print("sidis_reco_18on275.pdf");
  c5a->Print("sidis_reco_18on275.pdf");
  c5b->Print("sidis_reco_18on275.pdf");
  c5c->Print("sidis_reco_18on275.pdf");
  c5d->Print("sidis_reco_18on275.pdf");
  c6b->Print("sidis_reco_18on275.pdf");
  c6a->Print("sidis_reco_18on275.pdf");
  c7->Print("sidis_reco_18on275.pdf");
  c7a->Print("sidis_reco_18on275.pdf");
  c7b->Print("sidis_reco_18on275.pdf");
  c8->Print("sidis_reco_18on275.pdf");
  c8a->Print("sidis_reco_18on275.pdf");
  c9->Print("sidis_reco_18on275.pdf");
  c9a->Print("sidis_reco_18on275.pdf");
  c10->Print("sidis_reco_18on275.pdf");
  c10a->Print("sidis_reco_18on275.pdf");
  c11->Print("sidis_reco_18on275.pdf");
  c11a->Print("sidis_reco_18on275.pdf");
  c12->Print("sidis_reco_18on275.pdf");
  c13->Print("sidis_reco_18on275.pdf");
  c14a->Print("sidis_reco_18on275.pdf");
  c14b->Print("sidis_reco_18on275.pdf");
  c14c->Print("sidis_reco_18on275.pdf");
  c14d->Print("sidis_reco_18on275.pdf");
  c15a->Print("sidis_reco_18on275.pdf");
  c15b->Print("sidis_reco_18on275.pdf");
  c15c->Print("sidis_reco_18on275.pdf");
  c15d->Print("sidis_reco_18on275.pdf");
  c15e->Print("sidis_reco_18on275.pdf");
  c15f->Print("sidis_reco_18on275.pdf");
  c16f->Print("sidis_reco_18on275.pdf");
  c16d->Print("sidis_reco_18on275.pdf");
  c16e->Print("sidis_reco_18on275.pdf");
  c16a->Print("sidis_reco_18on275.pdf");
  c16b->Print("sidis_reco_18on275.pdf");
  c16c->Print("sidis_reco_18on275.pdf");
  c17->Print("sidis_reco_18on275.pdf");
  c18b->Print("sidis_reco_18on275.pdf");
  c18a->Print("sidis_reco_18on275.pdf");
  c18->Print("sidis_reco_18on275.pdf");
  c19a->Print("sidis_reco_18on275.pdf");
  c19b->Print("sidis_reco_18on275.pdf");
  c19->Print("sidis_reco_18on275.pdf");
  c20a->Print("sidis_reco_18on275.pdf");
  c20b->Print("sidis_reco_18on275.pdf");
  c20->Print("sidis_reco_18on275.pdf");
  c21a->Print("sidis_reco_18on275.pdf");
  c21b->Print("sidis_reco_18on275.pdf");
  c21->Print("sidis_reco_18on275.pdf");
  c22a->Print("sidis_reco_18on275.pdf");
  c22b->Print("sidis_reco_18on275.pdf");
  c22->Print("sidis_reco_18on275.pdf");
  c23a->Print("sidis_reco_18on275.pdf");
  c23b->Print("sidis_reco_18on275.pdf");
  c23c->Print("sidis_reco_18on275.pdf");
  for(int D = 0; D <8; D++) { 
    c24[D]->Print("sidis_reco_18on275.pdf"); }
  for(int D = 0; D <8; D++) {
    c25[D]->Print("sidis_reco_18on275.pdf");};
  for(int D = 0; D <8; D++) {
    c26[D]->Print("sidis_reco_18on275.pdf");};
  c27a->Print("sidis_reco_18on275.pdf");
  c27b->Print("sidis_reco_18on275.pdf");
  c28a->Print("sidis_reco_18on275.pdf");
  c28b->Print("sidis_reco_18on275.pdf");
  c28c->Print("sidis_reco_18on275.pdf");
  c28d->Print("sidis_reco_18on275.pdf");
  c28e->Print("sidis_reco_18on275.pdf");
  c29->Print("sidis_reco_18on275.pdf");
  c30a->Print("sidis_reco_18on275.pdf");
  c1a->Print("sidis_reco_18on275.pdf]");
